...
from allennlp.data.dataset_readers.transformer_span_reasoning import TransformerSpanReasoningReader
from allennlp.data.dataset_readers.transformer_span_reasoning_syntax import TransformerSpanReasoningSyntaxReader
from allennlp.data.dataset_readers.transformer_span_reasoning_single import TransformerSpanReasoningSingleReader
from allennlp.data.dataset_readers.transformer_sequence_labelling import TransformerSequenceLabellingReader
